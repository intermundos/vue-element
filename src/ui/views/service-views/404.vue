...
<!--    <div class="min-w-screen min-h-screen bg-light-400 flex items-center p-5 lg:p-20 overflow-hidden relative">-->
<!--      <div-->
...
<!--            <h1 class="font-black uppercase text-3xl lg:text-5xl text-b-red mb-10">You seem to be lost!</h1>-->
<!--            <p>The page you're looking for isn't available.</p>-->
<!--          </div>-->
<!--          <div class="mb-20 md:mb-0">-->
<!--            <button class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-b-red hover:text-pink-600"-->
